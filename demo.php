        ...
        <h1>Cart</h1>
            ...
            ?>
                ...
                <tr class="hist-tr" style="color:red; border:1px solid black;">
                    ...
                    <td align="center">
                        <?php  echo isset($row["total"]) ? $row["total"]: "0"; ?>
                    </td>
                </tr>

            </table>
            <span style="color:black; border: 1px solid ; background-color: red;"><a href="modify.php" style="color: black ; text-decoration: none; font-weight: bold;">Modify Cart</a></span>
            <span style="color:black; border: 1px solid ; background-color: green"><a href="checkout.php" style="color: black ; text-decoration: none; font-weight: bold;">Proceed To Checkout</a></span>
