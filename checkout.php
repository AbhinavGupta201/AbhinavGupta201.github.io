...
<body>
  ...
  <div class="row">
    <div class="col-75">
            ...
            <p>Grand Total <span class="price" style="color:black"><b> <?php  echo isset($row["total"]) ? $row["total"]: "NULL"; ?></b></span></p>
            <div class="container">
        <form action="action_page.php" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <label for="nam"><i class="fa fa-address-card-o"></i>Name</label>
              <input type="text" id="adr" name="nam" placeholder="Satyam Chaudhari" required>
              <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
              <input type="text" id="adr" name="address" placeholder="nitk, " required>
              <label for="city"><i class="fa fa-institution"></i> Alternet Mobile no.</label>
              <input type="number" id="Mobile" name="Mobile" placeholder="99201901289" required>
            </div>
          </div>
